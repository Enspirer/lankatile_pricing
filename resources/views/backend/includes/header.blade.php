<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/brand/lanka-tiles-logo.png') }}" width="140" height="35" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="{{ asset('img/backend/brand/lanka-tiles-logo.png') }}" width="40" height="10" alt="CoreUI Logo">
    </a>
